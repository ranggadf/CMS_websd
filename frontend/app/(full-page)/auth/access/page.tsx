            ...
            <div className="flex flex-column align-items-center justify-content-center">
                ...
                >
                    <div className="w-full surface-card py-8 px-5 sm:px-8 flex flex-column align-items-center" style={{ borderRadius: '53px' }}>
                        ...
                        <div className="text-600 mb-5">Anda tidak memiliki izin untuk mengakses halaman ini.</div>
                        <img src="/demo/images/access/asset-access.svg" alt="Error" className="mb-5" width="80%" />
                        <Button icon="pi pi-arrow-left" label="kembali ke Login" text onClick={() => router.push('/auth/login')} />
                    </div>
                </div>
            </div>
        </div>
