...
interface TabunganDepositoKoperasiBankLainPageProps {
...
const TabunganDepositoKoperasiBankLainPage: React.FC<TabunganDepositoKoperasiBankLainPageProps> = ({ onChange, defaultValue }) => {
    ...
    const handleRadioChange = (e: RadioButtonChangeEvent) => {
        onChange({ jenis: e.value });
    };

    return (
        <form>
            <fieldset className="mb-4 p-4 border-round">
                <legend className="text-xl font-bold">Tabungan Deposito Koperasi Bank Lain</legend>
                <div className="grid">
...
export default TabunganDepositoKoperasiBankLainPage